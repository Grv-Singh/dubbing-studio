...
// ── Default Script ────────────────────────
const DEFAULT_SCRIPT = `🎬 DUBBING SCRIPT — Monster: Johan Liebert Dub
════════════════════════════════

[00:00.0 - 00:23.5] [SLOW / DHEEMA]
🎧 [Intro & Schuwald's Dialogue] — Original audio playing. Johan ka cue 23.5s par hai!

[00:23.5 - 00:30.0] [CHILLING / CALM]
🎭 JOHAN: Mere zehen mein... isse bhi zyada dilchasp ek khayal aaya hai.
(English: Something that's even more compelling has popped into my head.)

[00:30.5 - 00:35.0] [COLD / SOFT]
🎭 JOHAN: Kya aapko abhi bhi darr nahi lag raha, Mr. Schuwald?
(English: You're not afraid even now, Mr. Schuwald?)

[00:35.2 - 00:43.3] [SLOW / DHEEMA]
🎧 [Schuwald's Outro] — Original audio playing: "Answer me this... where did you come from?"

════════════════════════════════
TIPS:
• 00:00 - 23.5s: Schuwald ka dialogue chalega (Original audio video me automatic mix rahegi).
• 23.5s par Johan ka cue: Ekdum thandi, shaant aur bina darr wali aawaaz (Johan's whisper-calm tone).
• 35.2s ke baad Schuwald wapas bolta hai (original preserved).
• Video merge me sirf Johan ki aawaaz replace hogi, Schuwald ki aawaaz intact rahegi!`;
